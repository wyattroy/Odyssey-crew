...
- [x] **Phase 3: Economy & Verb Redesign (Anchors + Balance)** - Two verbs (Abide/Dare), favor as the single divine currency and revival lifeline, anchors on the same grammar, tuned so cooperation wins and defection merely survives (completed 2026-07-26)
...
- [x] 03-01-PLAN.md — Tracer: two verbs + favor as the single divine currency (seas, doom) proven end-to-end on Helios, plus the econ/parity/sweep measurement instruments; one-way decision gates for D-01 and D-04 (ECON-01, ECON-02)

**Wave 2** *(blocked on Wave 1 — same file)*

- [x] 03-02-PLAN.md — Favor as lifeline: revival on any beat (self-pay or a crewmate pays), favor bankruptcy as the only permanent end, and a fuller crew easing the voyage (ECON-03, ECON-04)

**Wave 3** *(blocked on Wave 2 — same file)*

- [x] 03-03-PLAN.md — Cyclops + Lotus re-authored to two verbs with escalating tiers, drunk/stake/boast and lotus-struck/rescue mechanics intact (BALANCE-01)

**Wave 4** *(blocked on Wave 3 — same file)*

- [x] 03-04-PLAN.md — Sirens re-authored (reef doom off crew favor, Dare-favor exception settled) + whole-game favor-law audit and contested-favor measurement (BALANCE-03)

**Wave 5** *(blocked on Wave 4 — same file)*

- [x] 03-05-PLAN.md — Hades + Phaeacia retrofitted onto the two-verb grammar via a new ANCHORS structure, peek/revival and the favor-weighted gifts-only court intact (ANCHOR-01, ANCHOR-02)
...
- [x] 03-07-PLAN.md — Balance retune against the fixed multi-seed sweep until assert mode passes (CONFIG-only diff) + PROJECT.md two-verb identity ripple (BALANCE-02)
...
| 3. Economy & Verb Redesign (Anchors + Balance) | v1.1 | 7/7 | Complete    | 2026-07-26 |
